...
public class LoginActivity extends AppCompatActivity {
    ...
    public void login() {
        ...
        String where = ACCOUNTS_COLUMN_EMAIL + "=" + email + "AND" + ACCOUNTS_COLUMN_PASSWORD + "=" + password;
        Cursor c = SqlConnect.Select_Data(ACCOUNTS_TABLE_NAME, null, where, null, null, null, null);
